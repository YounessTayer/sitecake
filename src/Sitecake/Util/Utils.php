...
class Utils
{
    ...
    public static function array_map_prop($array, $property)
    {
    ...
    public static function array_filter_prop($array, $property, $value)
    {
    ...
    public static function array_find_prop($array, $prop, $value)
    {
    ...
    public static function iterable_to_array($iterable)
    {
        $res = [];
    ...
    public static function str_endswith($needle, $haystack)
    {
        $len = strlen($needle);
     ...
     * @return int
     */
    public static function match($ps_pattern, $ps_subject, &$pa_matches, $pn_flags = PREG_PATTERN_ORDER, $pn_offset = 0,
                                 $ps_encoding = null)
    {
