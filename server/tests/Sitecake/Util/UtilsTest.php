...
class UtilsTest extends \PHPUnit_Framework_TestCase {
	...
	*/
	...
	function test_isResourceUrl() {
		$this->assertTrue(Utils::isScResourceUrl('files/doc-sc123456789abcd.doc'));
		$this->assertTrue(Utils::isScResourceUrl('files/doc-sc123456789abcd00.doc'));
		$this->assertTrue(Utils::isScResourceUrl('images/image-2-sc123456789abcd-00.jpg'));
		$this->assertFalse(Utils::isScResourceUrl('#files/doc-sc123456789abcd.doc'));
		$this->assertFalse(Utils::isScResourceUrl('javascript:files/doc-sc123456789abcd-00.doc'));
		$this->assertFalse(Utils::isScResourceUrl('http://some.come/files/doc-sc123456789abcd.doc'));
	}

	function testIsExternalNavLink()
	{
		...
		$this->assertTrue(Utils::isExternalNavLink('https://www.google.com'));

		$this->assertFalse(Utils::isExternalNavLink('https://test.sitecake.com/about'));
		$this->assertFalse(Utils::isExternalNavLink('/'));
		$this->assertFalse(Utils::isExternalNavLink('/about.html'));
		$this->assertFalse(Utils::isExternalNavLink('/dir/about.html'));
		$this->assertFalse(Utils::isExternalNavLink('dir/about.html'));
		$this->assertFalse(Utils::isExternalNavLink('about.html'));
	}
