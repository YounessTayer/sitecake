 ...
 */
$app['pages.use_document_relative_paths'] = true;
/**
 * The main navigation item template
 */
$app['pages.nav.item_template'] = '<a class="${active}" href="${url}">${title}</a>';
/**
 * An alternative nav configuration example, using <ul> tag as the container and <li> tags for menu items
 */
